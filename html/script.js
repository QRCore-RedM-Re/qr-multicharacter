    ...
    window.addEventListener('message', function (event) {
        ...
        if (data.action == "ui") {
            ...
            if (data.toggle) {
                ...
                setTimeout(function(){
					setCharactersList()
                    $.post('https://qr-multicharacter/setupCharacters');
                    setTimeout(function(){
...
$('.disconnect-btn').click(function(e){
    ...
    $.post('https://qr-multicharacter/closeUI');
    $.post('https://qr-multicharacter/disconnectButton');
});
...
$(document).on('click', '#create', function (e) {
    ...
    $.post('https://qr-multicharacter/createNewCharacter', JSON.stringify({
        firstname: firstname,
        lastname: lastname,
...
$(document).on('click', '#accept-delete', function(e){
    $.post('https://qr-multicharacter/removeCharacter', JSON.stringify({
...
$(document).on('click', '#play', function(e) {
    ...
    if (selectedChar !== null) {
        if (charData !== "") {
            $.post('https://qr-multicharacter/selectCharacter', JSON.stringify({
